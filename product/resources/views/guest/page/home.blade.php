...
<section class="hero" data-aos="fade-up" data-aos-duration="1000">
    ...
    {{-- FORM PENCARIAN diarahkan ke pencarian guest --}}
...
<section class="section-container" style="background: #f4f7f5;">
    ...
    <section class="koleksi-unggulan-section">
        <div class="koleksi-unggulan-header" data-aos="fade-up">
            ...
            {{-- Diarahkan ke koleksi elektronik karena guest hanya punya akses tersebut --}}
        ...
        <div class="koleksi-unggulan-grid">
            ...
            <div class="koleksi-hero-card" data-aos="fade-right" data-aos-duration="800">
                ...
                <div class="koleksi-hero-overlay">
                    ...
                    {{-- Tombol detail arahkan ke login karena guest harus login untuk melihat detail --}}
                    <a href="{{ route('login') }}" class="koleksi-hero-btn">
                        Lihat Detail
                    </a>
                </div>
            </div>
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:30px;" data-aos="fade-up">
        ...
        <a href="{{ route('guest.berita.index') }}" style="color:var(--primary-color);font-weight:800;font-size:0.9rem;text-transform:uppercase;letter-spacing:1px;border-bottom:2px solid var(--primary-color);padding-bottom:2px;">
