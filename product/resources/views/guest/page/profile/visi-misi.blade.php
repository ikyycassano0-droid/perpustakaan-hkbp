{{-- resources/views/guest/page/profile/visi-misi.blade.php --}}
...
<style>
    /* ============================================
       STYLE KHUSUS HALAMAN VISI & MISI
...
@section('content')
    ...
    <div class="main-layout">
        ...
        <!-- Sidebar (tetap menggunakan route yang sesuai) -->
        <aside class="sidebar" data-aos="fade-left" data-aos-delay="100">
            ...
            <ul class="sidebar-menu">
                <li>
                    <a href="{{ route('guest.profile.visi-misi') }}" class="active">
