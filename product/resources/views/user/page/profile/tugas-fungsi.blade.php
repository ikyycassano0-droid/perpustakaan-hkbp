...
<style>
    ...
    .misi-card-new:hover {
        ...
        box-shadow:
            0 20px 35px -12px rgba(99, 102, 241, 0.3);
    }
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="glass-card p-3 rounded-2xl img-hover soft-shadow fade-up">
                    ...
                    @if($tujuanImage && $tujuanImage->image)
                        <img
                            src="{{ asset('storage/' . $tujuanImage->image) }}"
                            class="rounded-xl w-full"
                            alt="{{ $tujuanImage->title ?? 'Tujuan Kami' }}"
                        >
                    @else
                        <img
                            src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=600&h=450&fit=crop"
                            class="rounded-xl w-full"
                            alt="Default Image"
                        >
                    @endif
                ...
                <div class="fade-up">
                    ...
                    <button
                        class="btn mt-8"
                        onclick="showNotif('Jelajahi koleksi kami di perpustakaan digital!', 'success')"
                    >
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const rectCardsAnimate =
            document.querySelectorAll('.card-rectangle');
        ...
        const misiCards =
            document.querySelectorAll('.misi-card-new');
    ...
    console.log(
        'Halaman Tugas & Fungsi siap dengan efek card rectangle glow follow cursor dan tilt 3D!'
    );
</script>
@endpush
