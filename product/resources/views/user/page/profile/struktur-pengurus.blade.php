{{-- resources/views/user/page/profile/struktur-pengurus.blade.php --}}
    ...
    <div class="main-layout">
        ...
        <aside class="sidebar" data-aos="fade-left" data-aos-delay="200">
            ...
            <ul class="sidebar-menu">
                <li><a href="{{ route('user.profile.visi_misi') }}"><i class="fas fa-lightbulb"></i> Visi, Misi, & Sasaran</a></li>
                <li><a href="{{ route('user.profile.kerjasama') }}"><i class="fas fa-handshake"></i> Kerjasama</a></li>
                <li><a href="{{ route('user.profile.struktur') }}" class="active"><i class="fas fa-users"></i> Struktur Pengurus</a></li>
                <li><a href="{{ route('user.profile.tugas_fungsi') }}"><i class="fas fa-tasks"></i> Tugas, Fungsi, Tujuan</a></li>
            </ul>
        </aside>
    </div>
@endsection
