{{-- resources/views/user/page/Koleksi/Koleksi_Tercetak/detail_buku_referensi.blade.php --}}
...
@section('content')
    <div class="main-wrapper">
        ...
        <div class="book-wrap" data-aos="zoom-in-right">
            <div class="real-book">
                ...
                <div class="book-pages">
                    <h3><i class="fas fa-feather-alt"></i> Deskripsi</h3>
                    <p>{{ Str::limit($collection->description ?? 'Tidak ada deskripsi untuk buku referensi ini.', 350) }}</p>
                    ...
                    <div class="pages-meta">
                        ...
                        <span><i class="fas fa-book"></i> Buku Referensi</span>
                    </div>
                </div>
                ...
                <div class="book-cover">
                    ...
                    @else
                        <img src="https://via.placeholder.com/400x600?text=Buku+Referensi+Cover" alt="Default Cover">
                    @endif
                </div>
            </div>
            ...
            <div class="ebook-actions">
                ...
                <a href="{{ route('user.koleksi.buku_referensi') }}" class="btn-download btn-ebook" style="text-decoration:none;">
                    <i class="fas fa-arrow-left"></i> Kembali ke Menu Buku Referensi
                </a>
            </div>
        </div>
        ...
        <div class="detail-box" data-aos="fade-left">
            <div class="title-area">
                <span class="top-tag">
                    <i class="fas fa-book"></i> KOLEKSI BUKU REFERENSI
                </span>
            ...
            <div class="info-list">
                ...
                <div class="info-row">
                    ...
                    <div class="value">Buku Referensi (Hanya untuk dibaca di ruang baca)</div>
                </div>
            </div>
            ...
            <div style="margin-top: 30px;">
                ...
                @else
                    <button class="btn-ebook btn-read" id="btnPinjamBawah"><i class="fas fa-book-reader"></i> PINJAM SEKARANG</button>
                @endif
                <a href="{{ route('user.koleksi.buku_referensi') }}" class="btn-back">Kembali ke Menu Buku Referensi</a>
            </div>
        </div>
    </div>
    ...
    <div id="pinjamModal" class="modal-overlay">
        <div class="modal-container">
            <h2><i class="fas fa-calendar-check" style="color:var(--primary-color);"></i> Form Peminjaman Buku Referensi</h2>
