{{-- resources/views/user/page/Koleksi/Koleksi_Tercetak/buku_pengayaan.blade.php --}}
@extends('user.component.master')

@section('title', 'Koleksi Buku Pengayaan - AKPER HKBP')
        ...
        <div class="book-list">
            @forelse($collections as $collection)
                @php
                    ...
                    $coverUrl = $collection->cover_image
                                ...
                                : 'https://via.placeholder.com/140x190?text=Buku';
                ...
                <div class="book-card">
                    ...
                    <div class="book-info">
                        <span class="category-label">BUKU PENGAYAAN</span>
            ...
            @empty
                <div class="empty-state">
                    ...
                    <h3>Tidak ada buku pengayaan ditemukan</h3>
                    <p>
                        @if(request('year_min') || request('year_max') || request('category') || request('search'))
                            ...
                            <br>Coba ubah atau <a href="{{ route('user.koleksi.buku_pengayaan') }}" style="color: var(--primary-color); text-decoration: underline;">reset filter</a>.
                        @else
                            Belum ada buku pengayaan yang tersedia saat ini.
                        @endif
                    </p>
                </div>
            @endforelse
