{{-- resources/views/user/page/Koleksi/Koleksi_Tercetak/buku_referensi.blade.php --}}
@extends('user.component.master')

@section('title', 'Koleksi Buku Referensi - AKPER HKBP')
...
<div class="main-container">
    {{-- SIDEBAR MINIMALIS SAMA SEPERTI JURNAL --}}
    <aside class="sidebar">
    ...
    <main class="content-section">
        <div class="page-header">
            ...
            <h2>Koleksi Buku Referensi</h2>
        </div>

        <div class="filter-row">
            <div class="search-item">
                <i class="fas fa-search"></i>
                <input type="text" placeholder="Cari judul referensi, penulis, atau ISBN..."
        ...
        <div class="book-list">
            @forelse($collections as $collection)
                @php
                    ...
                    $coverUrl = $collection->cover_image
                                ...
                                : 'https://via.placeholder.com/140x190?text=Referensi';
                ...
                <div class="book-card">
                    ...
                    <div class="book-info">
                        <span class="category-label">BUKU REFERENSI</span>
            ...
            @empty
                <div class="empty-state">
                    ...
                    <h3>Tidak ada buku referensi ditemukan</h3>
                    <p>
                        @if(request('year_min') || request('year_max') || request('category') || request('search'))
                            Maaf, tidak ada buku yang sesuai dengan filter yang dipilih.
                            <br>Coba ubah atau <a href="{{ route('user.koleksi.buku_referensi') }}" style="color: var(--primary-color); text-decoration: underline;">reset filter</a>.
                        @else
                            Belum ada buku referensi yang tersedia saat ini.
                        @endif
                    </p>
                </div>
            @endforelse
