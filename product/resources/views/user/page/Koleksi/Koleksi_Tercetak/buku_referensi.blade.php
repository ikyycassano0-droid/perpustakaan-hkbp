...
<div class="main-content">
    ...
    Koleksi Buku <br>
    <span class="bg-gradient-to-r from-indigo-400 via-purple-400 to-indigo-300 bg-clip-text text-transparent glow-text">Referensi</span>
</h1>
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            @if($item->cover_image)
                                                <img
                                                    ...
                                                    alt="{{ $item->title }}"
                                                    class="w-16 h-24 object-cover rounded-xl border border-indigo-500/30 shadow-lg"
                                                >
                                            @else
                                                <div class="w-16 h-24 rounded-xl flex items-center justify-center
                                                            bg-gradient-to-br from-indigo-500/20 to-purple-500/20
                                                            border border-indigo-500/30 text-3xl">
                                                    📘
                                                </div>
                                            @endif
                                        </div>
