    ...
    <div class="main-wrapper">
        ...
        <div class="book-wrap" data-aos="zoom-in-right">
            ...
            <div class="ebook-actions">
                ...
                <a href="{{ route('user.koleksi.jurnal') }}" class="btn-ebook btn-back-action" style="text-decoration:none;">
        ...
        <div class="detail-box" data-aos="fade-left">
            ...
            <div class="section-header">
                ...
                Status Ketersediaan <span>— Rak Koleksi</span>
            </div>
            ...
            <div class="abstract-content">
                <h4><i class="fas fa-align-left"></i> Abstrak / Deskripsi</h4>
