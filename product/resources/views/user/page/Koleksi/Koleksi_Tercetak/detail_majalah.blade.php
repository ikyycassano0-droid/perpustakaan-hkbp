...
<div class="main-wrapper">
    <div class="book-wrap" data-aos="zoom-in-right">
        <div class="book">
            <div class="spine"></div>
            <div class="cover">
                <img src="{{ $collection->cover_image ? asset('storage/'.$collection->cover_image) : 'https://via.placeholder.com/400x600?text=Majalah+Cover' }}" alt="Cover">
            </div>
            <div class="page">
                <h2>Sinopsis</h2>
                <p>{{ Str::limit($collection->description ?? 'Tidak ada sinopsis.', 200) }}</p>
        ...
        <a href="{{ route('user.koleksi.majalah') }}" class="btn-back">
    ...
    <div class="detail-box" data-aos="fade-left">
        <div class="title-area">
            <span style="color: var(--accent-green); font-weight: 800; font-size: 0.75rem; text-transform: uppercase;">Koleksi Majalah & Serial</span>
            ...
            <div class="author-edition">
                ...
                @if($collection->edition) Edisi {{ $collection->edition }}, @endif
