...
<div class="main-wrapper">
    <div class="book-wrap" data-aos="zoom-in-right">
        <div class="book">
            <div class="spine"></div>
            <div class="cover">
                <img src="{{ $collection->cover_image ? asset('storage/'.$collection->cover_image) : 'https://via.placeholder.com/400x600?text=Buku+Cover' }}" alt="Cover">
            </div>
            <div class="page">
                <h2>Sinopsis</h2>
        ...
        <a href="{{ route('user.koleksi.buku_pengayaan') }}" class="btn-back">
    ...
    <div class="detail-box" data-aos="fade-left">
        <div class="title-area">
            <span style="color: var(--accent-green); font-weight: 800; font-size: 0.75rem; text-transform: uppercase;">Koleksi Buku Pengayaan</span>
