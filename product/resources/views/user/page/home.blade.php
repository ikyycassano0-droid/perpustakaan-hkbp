...
<section class="text-center mt-40 px-6">
    ...
    <div class="max-w-3xl mx-auto">
        <form action="{{ route('user.global_search') }}" method="GET" class="relative">
    ...
    <div class="mt-20 flex justify-center">
        <div class="tilt glass p-8 rounded-3xl shadow-2xl float" id="tiltCard">
            <img src="{{ asset('assets/img/gedung.png') }}" alt="Gambar Perpustakaan"
...
<section class="mt-40 grid md:grid-cols-3 gap-10 px-10 text-center">
    ...
    <a href="{{ route('user.profile.visi_misi') }}" class="block">
