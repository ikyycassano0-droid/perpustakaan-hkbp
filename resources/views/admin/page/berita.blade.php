            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-slate-50 hover:bg-slate-50/30 transition">
                        {{-- FORM UPDATE dalam satu baris --}}
                        <form action="{{ route('admin.berita.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="contents">
                            @csrf
                            @method('PUT')

                            {{-- JUDUL --}}
                            <td class="px-6 py-3">
                                <input type="text" name="title" value="{{ $item->title }}" class="w-full px-3 py-2 rounded-lg border border-slate-200 bg-slate-50/30 focus:bg-white focus:outline-none focus:border-indigo-300 focus:ring-1 focus:ring-indigo-200 transition text-sm text-slate-700">
                            </td>

                            {{-- KATEGORI --}}
                            <td class="px-6 py-3">
                                <select name="category" class="w-full px-3 py-2 rounded-lg border border-slate-200 bg-slate-50/30 focus:bg-white focus:outline-none focus:border-indigo-300 focus:ring-1 focus:ring-indigo-200 transition text-sm text-slate-700">
                            ...
                            {{-- EXCERPT --}}
                            <td class="px-6 py-3">
                                <input type="text" name="excerpt" value="{{ $item->excerpt }}" class="w-full px-3 py-2 rounded-lg border border-slate-200 bg-slate-50/30 focus:bg-white focus:outline-none focus:border-indigo-300 focus:ring-1 focus:ring-indigo-200 transition text-sm text-slate-700">
                             </td>
...
{{-- CKEditor Script (opsional, untuk content) --}}
